...
class FavoriteProductDetail extends StatefulWidget {
  final String favoriteid;
  const FavoriteProductDetail({super.key, required this.favoriteid});

  @override
  State<FavoriteProductDetail> createState() => _FavoriteProductDetailState();
}

class _FavoriteProductDetailState extends State<FavoriteProductDetail> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<DocumentSnapshot>(
      future: productdet.doc(widget.favoriteid).get(),
      builder:
